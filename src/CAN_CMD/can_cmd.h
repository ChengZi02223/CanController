...
extern const std::vector<uint8_t> SDO_SAVE_EEPROM_CMD; // 保存个人设置
...
extern const std::vector<uint8_t> RESPONSE_SAVETO_EEPROM_CMD;      //保存到EEPROM
extern const std::vector<uint8_t> RESPONSE_SAVE_DEFAULT_VALUE;      //保存默认参数
extern const std::vector<uint8_t> RESPONSE_READ_TO_TABLE;      //读取参数到表格
